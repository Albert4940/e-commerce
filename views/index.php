...
<body>
	...
	<section id="section_index">
		<div id="mission">
			<center>
				<h1 style="font-size:30px">What is our mission ?</h1>
			<p style="font-size:30px">We, as a group of coders, wanted to show our love of coding through something material. <br>Something we can wear proudly or sometimes sarcastically to show others our passion. <br>

			Wearing our merch means you are not scared to show your feeling about what you love.</p>
			</center>
		</div>
		<div id="img">
			<img src="../img/espace.webp" >
		</div>
	</section>
